This is a University Management System(UMS) that i created using Winforms .NET Technology in tandem with an MS SQL SERVER Database.This app has 3 different roles that i will display later.
